     ...
     class Program
    {
        static void Main(string[] args)
        {
            ...
            do // Adding products to users order
            {
                ...
                Console.WriteLine("Want to continue? (yes/no) (First ID + space + amount)");
            ...
            if (action == "edit")
            {
                ...
                OrderDetailsDAO.updateByProductIdAndCustomerId(Convert.ToInt32(stringArray[0]), Convert.ToInt32(stringArray[1]), orderId);

            } else if (action == "delete")
            {
                dao3.GetAll().ToList().ForEach(x => { // making sure that customer_ids are matching
            ...
            Console.WriteLine("Please write us a short review"); // Users review
            string userreview = Console.ReadLine();
            review1.Reviewtext = userreview;
